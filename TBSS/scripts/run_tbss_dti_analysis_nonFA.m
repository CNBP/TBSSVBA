function run_tbss_dti_analysis_nonFA(im_type_folder,TBSS_FOLDER,NATIVE_IM_FOLDER, TRANS_FOLDER, fa_thresh,g1,g2,perm )
...
if skel_bool
    ...
    argsR=[' ' im_type_folder ' ' TBSS_FOLDER ' ' '*.nii.gz' ' ' num2str(fa_thresh) ' ' parts{end}];
