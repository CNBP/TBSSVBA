function run_tbss_dti_analysis_asym( TENSOR_FOLDER,DATA_FOLDER,regex, TBSS_FOLDER,fa_thresh,g1,g2,perm,skel_bool,proj_bool,stat_bool,deproj_all_bool)
...
if skel_bool
    scriptR='scripts/tbss_make_sym_skel_dtitk.sh';
    
    argsR=[' ' TENSOR_FOLDER ' ' DATA_FOLDER ' ' regex ' ' altim ' ' TBSS_FOLDER ' ' num2str(fa_thresh)];
