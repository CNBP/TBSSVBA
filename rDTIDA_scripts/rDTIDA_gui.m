...
% Last Modified by GUIDE v2.5 25-Jan-2016 12:25:06
...
% --- Executes on button press in pushbutton_tbss.
function pushbutton_tbss_Callback(hObject, eventdata, handles)
% hObject    handle to pushbutton_tbss (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)


% --- Executes on button press in pushbutton_tenplate.
function pushbutton_tenplate_Callback(hObject, eventdata, handles)
% hObject    handle to pushbutton_tenplate (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
